package com.article.api.security.service;

import com.article.api.entities.Token;
...
import com.article.api.security.repository.TokenRepository;
...
public class AuthenticationService {
    ...
    public AuthenticationResponse register(RegisterRequest request) {
        ...
        var userSearch = repository.findByEmail(request.getEmail());

        if (userSearch.isPresent()) {
            throw new RegisterException(request.getEmail() + " is already registered.");
        }
